...
```
docker pull larserdmann/veracrypt-in-docker:1.9
```
...
docker run -d -t -i \
    ...
    larserdmann/veracrypt-in-docker:1.9
```
...
docker run -t -i \
	...
	larserdmann/veracrypt-in-docker:1.9 -h
```
...
```
docker build -t larserdmann/veracrypt-in-docker:1.9 .
```
